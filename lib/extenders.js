module.exports = (function(core){
  ...
  */
  ...
  core.ImmutateHistory = core.Class({
    ...
    size: function(){ return this.history.length; },
    push: function(f){
  ...
  //     },
  //     iterator: function(f){
  //      core.Asserted(false,'implement detail in child');
  //     },
  //   },{
  //    value: function(){
  //      var args = core.enums.toArray(arguments),
  ...
  //        if(core.valids.String(first))
  //          return core.ListSequence.make.apply(core.ListSequence,[first.split('')].concat(rest));
  //        return core.ListSequence.make.apply(core.ListSequence,[[first]].concat(rest));
  //      }
  //      if(core.valids.List(first))
  //        return core.ListSequence.make.apply(core.ListSequence,args);
  //      if(core.valids.Object(first))
  //        return core.MapSequence.make.apply(core.MapSequence,args);
  //      if(core.Sequence.instanceBelong(first))
  //        return first;
  //    }
  // });

  // core.CollectionSequence = core.Sequence.extends({
  //   init: function(data,fcheck){
  //     if(core.Sequence.instanceBelongs(data)) this.$super(data);
  //     else{
  //       if(core.valids.Function(fcheck)) fcheck(data);
  //       this.$super(null);
  //       this._obj = data;
  //     }
  //   },
  //   iterator: function(fn,fc,config){
  //     if(core.valids.not.Function(fn)) return null;
  //     if(core.valids.exists(this.parent)) 
  //       return this.parent.iterator(fn,fc,config);
  //     return core.enums.nextIterator(this._obj,fn,fc,
  //         (core.valids.Object(config) ? config.scope : this),config);
  //   },
  //   value: function(){
  //     return this._obj;
  //   },
