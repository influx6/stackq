module.exports = (function(core){
 ...
 /* former schemes code */
  ...
  core.Class = function(attr,static,_super){
    ...
    klass.prototype.constructor = klass;
    klass.classConstructor = klass.prototype.classConstructor = klass;
    klass.constructor = klass;
    return klass;
  };
  ...
  */
  ...
  core.GatewaySequence = core.Sequence.extends({
    ...
    getSkipIterator: function(f,c){
      return this.core.getSkipIterator(f,c);
    },
    eachSkip: function(fc,fx,c){
      return this.core.eachSkip(fc,fx,c);
    },
    getSkipReverseIterator: function(f,c){
      return this.core.getSkipReverseIterator(f,c);
    },
    eachSkipReverse: function(fc,fx){
      return this.core.eachSkipReverse(fc,fx);
    },
    getReverseIterator: function(){
      return this.core.getReverseIterator();
    },
    eachReverse: function(fc,fx){
      return this.core.eachReverse(fc,fx);
    },
    each: function(fc,fx){
      return this.core.each(fc,fx);
    },
    getIterator: function(){
      return this.core.getIterator();
    },
    each: function(fc,fx){
      return this.core.each(fc,fx);
    },
    ...
    length: function(){
      if(core.valids.Function(this.core.length))
        return this.core.length();
      return this.toArray().length;
    },
    toObject: function(){
      return this.core.toObject();
    },
    memoized: function(){
      if(this.core.memoized) return this.core.memoized();
      return core.MemoizedSequence.make(this.core);
    },
    hasValue: function(f){
      return this.core.hasValue(f);
    },
    hasKey: function(f){
      return this.core.hasKey(f);
    },
    get: function(f){
      return this.core.get(f);
    },
    toSequenceFuture:function(){
      if(this.core.toSequenceFuture) return this.core.toSequenceFuture();
      var seqf = core.SequenceFuture.make(this);
      seqf.complete(this.core);
      return seqf;
    },
  });
  ...
  core.MemoizedSequence = core.OperationalSequence.extends({
    ...
    toSequenceFuture:function(){
     ...
     this.cachedSeqFuture = core.SequenceFuture(this.parent());
  ...
  core.ImmutateCursor = core.GatewaySequence.extends({
    ...
    snapshot: function(f){
      ...
      if(this.has(first))
        return this.coreSeq().get(first).snapshot(rest.join('.'));
  ...
  core.CollectionCursor = core.ImmutateCursor.extends({
    ...
    toObject: function(fn){
      var f = core.Immutate.detransformMutates(this.coreSeq()).values();
      if(core.valids.Function(fn)) fn.call(f,f);
      return f;
    },
    toJS: function(fn){
  ...
  core.ListCursor = core.CollectionCursor.extends({
    ...
    toObject: function(fn){
      var f = core.Immutate.detransformMutates(this.coreSeq(),true).values();
      if(core.valids.Function(fn)) fn.call(f,f);
      return f;
    },
    set: function(f,a){
