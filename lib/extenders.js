module.exports = (function(core){
  ...
  */
  ...
  core.GatewaySequence = core.Sequence.extends({
    ...
    length: function(){
      console.log('gatwayseq:',this.toArray());
  ...
  core.Immutate = core.Configurable.extends({
    ...
    transformMutatesSequence: function(seq,isList){
      ...
      var trans = function(v,k){
         return core.Immutate.transform(v).get();
      };
  ...
  core.ImmutateCursor = core.GatewaySequence.extends({
    ...
    coreSeq: function(){
      return this.box.get(this.box.length() - 1);
    },
    ...
    get: function(f){
      ...
      if(this.core().has(first))
        return this.core().get(first).get(rest.join('.'));
      return null;
    },
    value: function(){
      return this.toJS();
    ...
    newSequence: function(fx){
      ...
      var newData = fx(oldData) || oldData;
      
      if(newData === oldData) return this;
      if(core.Util.toJSON(newData) === core.Util.toJSON(oldData)) return this;
      
      var seq = this._prepData(newData);
      
      this.box.push(seq);
      this.switch(this.coreSeq());
