module.exports = (function(core){
  ...
  core.Class = function(attr,static,_super){
    ...
    klass.prototype.$closure = function(fn){
      return core.funcs.bind(fn,this);
    };

    klass.prototype.$scoped = function(name){
      if(!valids.isFunction(klass.prototype[name])) return null;
      if(scopedCache[name]) return scopedCache[name];
      return scopedCache[name] = core.funcs.bind(klass.prototype[name],this);
    };
