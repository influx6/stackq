module.exports = (function(){
  ...
  structs.StreamSelect = function(stream,shouldRemove){
  ...
  structs.TypeGenerator = function(fn){
    ...
    var isType = function(cs){
      if(cs.isType && valids.isFunction(cs.isType) && valids.exists(cs.isType())){
        return cs.isType() === sig;
      }
      else if(cs.constructor.isType && valids.isFunction(cs.constructor.isType)){
        return cs.constructor.isType() === sig;
      }
      return false;
    };
    ...
    var Shell =  function(gn,hn){
      ...
      var shell = function Shell(args){
        var args = valids.isArgument(args) ? args : arguments;
        if(this instanceof arguments.callee){
          if(valids.exists(willuse))
            willuse.apply(this,args);
      ...
      shell.isType = function(){
        return sig;
      };

      shell.prototype.isType = function(){
        return sig;
      };
