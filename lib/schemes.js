module.exports = (function(core){
  ...
  core.FutureStream = core.Future.extends({
    ...
    chainStream: function(fx){
      ...
      var dbfx = function(){
        fx.out().emitEvent.apply(fx.out(),['dataBegin'].concat(core.enums.toArray(arguments)));
      };
      var defx = function(){
        fx.out().emitEvent.apply(fx.out(),['dataEnd'].concat(core.enums.toArray(arguments)));
      };
