module.exports = (function(core){
  ...
  core.Immutate = core.Class({
      init: function(obj,ifClone,wait){
        ...
        if(core.Immutate.isType(obj)){
          ...
          this.__obj = obj;
            ...
            this.future = core.Future.make();
            if(!wait) this.future.complete(this);
            this.__objMut = {};
      ...
      then: function(){
        if(this.__isMut__) return this.__obj.then.apply(this.obj,arguments);
        return this.future.then.apply(this.future,arguments);
      },
      onError: function(){
        if(this.__isMut__) return this.__obj.onError.apply(this.obj,arguments);
        return this.future.onError.apply(this.future,arguments);
      },
      mutate: function(fn){
  ...
  core.Future = core.Class({
      ...
      wait: function(){
        ...
        // console.log('wait:',args.length,count);
        ...
        core.enums.eachSync(args,function(e,i,o,fn){
          ...
          e.then(function(){
            ...
            count += 1;
            // console.log('wait:',args.length,'completed:',count);
            return fn(null);
          });
          ...
          e.onError(function(){
            ...
            // console.log('wait:',args.length,'completedError:',count);
            return fn(ka);
          });
        },function(_,err){
  ...
  core.QueryStream = function(connection){
    ...
    _.funcs.selfReturn(ax,'query',function(t){
      ...
      return core.Future.wait.apply(core.Future,fsm);
    });
