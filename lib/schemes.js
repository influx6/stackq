module.exports = (function(core){
  ...
  core.StreamSelect = core.Class({
      ...
      bindStream: function(stream){
        ...
        var pk = this.streams.$closure(this.streams.emit);
        stream.on(pk);
  ...
  core.Stream = core.Class({
    init: function(){
      ...
      this.events.events('subscribersAddded');
      this.events.events('subscribersRemoved');
      ...
      var dataCount = this.$closure(function(){
    ...
    on: function(fn){
      ...
      this.events.emit('subscribersAdded',fn);
    },
    once: function(fn){
    ...
    off: function(fn){
      ...
      this.events.emit('subscribersRemoved',fn);
    },
    offOnce: function(fn){
