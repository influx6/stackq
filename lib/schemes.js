module.exports = (function(core){
  ...
  core.Provider = core.Class({
    init: function(fn){
      core.Asserted(core.valids.isFunction(fn),'please provide a default handler for request')
      this.proxys = core.Storage.make('providing proxy functions');
      this.proxys.add('default',fn);
    },
    provide: function(name,fn){
      this.proxys.add(name,fn);
    },
    get: function(name){
