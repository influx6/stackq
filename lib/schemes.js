module.exports = (function(core){
  ...
  core.Query = function(target,schema,fn){
    ...
    _.funcs.selfReturn(ax,'save',function(q){
        if(q) this.insert(q);
        push({'op':'$save',key: q},fid.save);
    });

    _.funcs.selfReturn(ax,'saveAndStream',function(q){
        if(q) this.insert(q);
        push({'op':'$saveAndStream',key: q},fid.save);
    });
  ...
  core.FunctionStore = core.Class({
    ...
    isEmpty: function(){
      return core.enums.length(this.registry) <= 0;
    },
    size: function(){
      return core.enums.length(this.registry);
    },
    clone: function(){
